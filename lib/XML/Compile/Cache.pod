...
See L<documentation in the base class|XML::Compile::Schema/"DESCRIPTION">.
 
=head1 METHODS

See L<documentation in the base class|XML::Compile::Schema/"METHODS">.
 
=head2 Constructors

See L<documentation in the base class|XML::Compile::Schema/"Constructors">.
...
See L<documentation in the base class|XML::Compile::Schema/"Accessors">.
...
See L<documentation in the base class|XML::Compile::Schema/"Compilers">.
...
See L<documentation in the base class|XML::Compile::Schema/"Administration">.
...
See L<documentation in the base class|XML::Compile::Schema/"DETAILS">.
...
This module is part of XML-Compile-Cache distribution version 1.00,
built on October 14, 2013. Website: F<http://perl.overmeer.net/xml-compile/>
