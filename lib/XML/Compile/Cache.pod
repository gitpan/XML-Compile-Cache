...
$obj-E<gt>B<typemap>([HASH|ARRAY|PAIRS])
...
$obj-E<gt>B<xsiType>([HASH|ARRAY|LIST])
...
$obj-E<gt>B<compileAll>(['READERS'|'WRITERS'|'RW', [NAMESPACE]])
...
XML::Compile::Cache-E<gt>B<dataToXML>(NODE|REF-XML-STRING|XML-STRING|FILENAME|FILEHANDLE|KNOWN)
...
XML::Compile::Cache-E<gt>B<findSchemaFile>(FILENAME)
...
This module is part of XML-Compile-Cache distribution version 0.98,
